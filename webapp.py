...
if(selected_option == 'TITOLI'):
	...
	if(info):
		...
		st.write("Finanziarie trimestrali  : " + msft.quarterly_financials)
		st.write("")				
		st.write("Maggiori Holder  : " + msft.major_holders)
		st.write("Maggiori Holder Istituzionali  : " + msft.institutional_holders)
		st.write("")			

		st.write("Bilancio : " + msft.balance_sheet)
		st.write("Bilancio Trimestrale : " + msft.quarterly_balance_sheet)
		st.write("")
		st.write("CashFlow : " + msft.cashflow)
		st.write("CashFlow Trimestrale : " + msft.quarterly_cashflow)
		st.write("")
		st.write("Utile : " + msft.earnings)
		st.write("Utile Trimestrale : " + msft.quarterly_earnings)	
		st.write("")				
		st.write("Sostenibilità : " + msft.sustainability)	
		st.write("Calendario : " + msft.calendar)	
		st.write("Notizie : " + msft.news)	
